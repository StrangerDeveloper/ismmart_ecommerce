...
class CategoryProductsView extends StatelessWidget {
  ...
  final CategoryProductsViewModel viewModel =
      Get.put(CategoryProductsViewModel());
    ...
    return Scaffold(
      appBar: CustomAppBar2(
        ...
        titleTextStyle: GoogleFonts.inter(
            fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.black3),
        containsLeading: true,
      ),
      body: Stack(
        children: [
          Obx(
            () => viewModel.retryCheck.value
                ? Column(
                          ...
                          GridView.builder(
                            ...
                            itemBuilder: (context, idx) {
                              Products productModel =
                                  viewModel.categoryProducts[idx];
                              return ProductItem2(
                                product: viewModel2.productList[idx],
